...
$e=$_POST["em"];
$ps=$_POST["pass"];
$sql="INSERT INTO `civil`( `fname`, `lname`, `gender`, `email`, `password`) VALUES ('$f','$l','$g','$e','$ps')";
...
<html>
    ...
    <div class="container-fluid mb-5">
        <div class="row border-top px-xl-5">
          ...
          <tr>
            <td>First Name</td>
            <td><input type="text" name="finame" placeholder="Enter the first name" ></td>
            <td>Last Name</td>
            <td><input type="text" name="lnam" placeholder="Enter the last name"></td>
</tr>
<tr>
<td>Gender</td>
    ...
    <td>Email</td>
    <td><input type="mail" name="em" placeholder="Enter the Email"></td>
</tr>
<tr>
    <td>Password</td>
