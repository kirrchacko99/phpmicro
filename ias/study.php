...
$i=$_POST["ed"];
$c=$_FILES["img"]["name"];
$c_tmp_name=$_FILES['img']['tmp_name'];
echo "<br>",$c;
move_uploaded_file($_FILES["img"]['tmp_name'],"uploads/".$_FILES["img"]['name']);
$sql="INSERT INTO `book`( `bname`, `bauthor`, `price`, `edition`, `photo`) VALUES ('$f','$l','$g','$i','$c')";
...
<td><input type="file" name="img">
              ...
              <tr>
            <td>
                <input type="submit" value="submit operations" name="su">
</td>
</tr>
</table>
</body>
